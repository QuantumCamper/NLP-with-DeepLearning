...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.labels_placeholder = tf.placeholder(tf.float32, shape=[self.config.batch_size
    ...
    def add_prediction_op(self):
        ...
        b = tf.Variable(tf.zeros([1, self.config.n_classes]), name='b')
        
        a = tf.matmul(self.input_placeholder, W) + b
        pred = softmax(a)
